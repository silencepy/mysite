...
def myself(request):
    ...
    return render(request, "accounts/myself.html", {"user": user, "userinfo": userinfo, "userprofile": userprofile})
...
def myself_edit(request):
    ...
    if request.method == "POST":
        ...
        if user_form.is_valid() * userprofile_form.is_valid() * userinfo_form.is_valid():
            ...
            userprofile.save()
            userinfo.save()
            return HttpResponseRedirect('/accounts/my-information/')
    else:
        ...
        return render(request, "accounts/myself_edit.html",
...
def my_image(request):
    if request.method == 'POST':
        ...
        return render(request, 'accounts/imagecrop.html', )
